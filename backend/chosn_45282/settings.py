"""
Django settings for chosn_45282 project.
...
WSGI_APPLICATION = 'chosn_45282.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "chosn_45282 API",
    "DESCRIPTION": "API documentation for chosn_45282 App",
    "VERSION": "v1",
}
